...
const (
	...
	LogServiceName = "panmail.v1.LogService"
)
...
const (
	...
	LogServiceListLogsProcedure = "/panmail.v1.LogService/ListLogs"
	// LogServiceStreamLogsProcedure is the fully-qualified name of the LogService's StreamLogs RPC.
	LogServiceStreamLogsProcedure = "/panmail.v1.LogService/StreamLogs"
)

// LogServiceClient is a client for the panmail.v1.LogService service.
...
// NewLogServiceClient constructs a client for the panmail.v1.LogService service. By default, it
...
func NewLogServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) LogServiceClient {
	...
	logServiceMethods := v1.File_panmail_v1_log_proto.Services().ByName("LogService").Methods()
...
// ListLogs calls panmail.v1.LogService.ListLogs.
...
// StreamLogs calls panmail.v1.LogService.StreamLogs.
func (c *logServiceClient) StreamLogs(ctx context.Context, req *connect.Request[v1.StreamLogsRequest]) (*connect.ServerStreamForClient[v1.LogEntry], error) {
	return c.streamLogs.CallServerStream(ctx, req)
}

// LogServiceHandler is an implementation of the panmail.v1.LogService service.
...
func NewLogServiceHandler(svc LogServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/panmail.v1.LogService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLogServiceHandler) ListLogs(context.Context, *connect.Request[v1.ListLogsRequest]) (*connect.Response[v1.ListLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.LogService.ListLogs is not implemented"))
}

func (UnimplementedLogServiceHandler) StreamLogs(context.Context, *connect.Request[v1.StreamLogsRequest], *connect.ServerStream[v1.LogEntry]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.LogService.StreamLogs is not implemented"))
}
