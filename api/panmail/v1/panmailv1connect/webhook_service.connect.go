...
const (
	...
	WebhookServiceName = "panmail.v1.WebhookService"
)
...
const (
	...
	// CreateWebhook RPC.
	WebhookServiceCreateWebhookProcedure = "/panmail.v1.WebhookService/CreateWebhook"
	// WebhookServiceListWebhooksProcedure is the fully-qualified name of the WebhookService's
	// ListWebhooks RPC.
	WebhookServiceListWebhooksProcedure = "/panmail.v1.WebhookService/ListWebhooks"
	// WebhookServiceDeleteWebhookProcedure is the fully-qualified name of the WebhookService's
	// DeleteWebhook RPC.
	WebhookServiceDeleteWebhookProcedure = "/panmail.v1.WebhookService/DeleteWebhook"
	// WebhookServiceUpdateWebhookProcedure is the fully-qualified name of the WebhookService's
	// UpdateWebhook RPC.
	WebhookServiceUpdateWebhookProcedure = "/panmail.v1.WebhookService/UpdateWebhook"
)

// WebhookServiceClient is a client for the panmail.v1.WebhookService service.
...
// NewWebhookServiceClient constructs a client for the panmail.v1.WebhookService service. By
...
func NewWebhookServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WebhookServiceClient {
	...
	webhookServiceMethods := v1.File_panmail_v1_webhook_service_proto.Services().ByName("WebhookService").Methods()
...
// CreateWebhook calls panmail.v1.WebhookService.CreateWebhook.
...
// ListWebhooks calls panmail.v1.WebhookService.ListWebhooks.
...
// DeleteWebhook calls panmail.v1.WebhookService.DeleteWebhook.
...
// UpdateWebhook calls panmail.v1.WebhookService.UpdateWebhook.
...
// WebhookServiceHandler is an implementation of the panmail.v1.WebhookService service.
...
func NewWebhookServiceHandler(svc WebhookServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/panmail.v1.WebhookService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWebhookServiceHandler) CreateWebhook(context.Context, *connect.Request[v1.CreateWebhookRequest]) (*connect.Response[v1.CreateWebhookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.WebhookService.CreateWebhook is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) ListWebhooks(context.Context, *connect.Request[v1.ListWebhooksRequest]) (*connect.Response[v1.ListWebhooksResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.WebhookService.ListWebhooks is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) DeleteWebhook(context.Context, *connect.Request[v1.DeleteWebhookRequest]) (*connect.Response[v1.DeleteWebhookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.WebhookService.DeleteWebhook is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) UpdateWebhook(context.Context, *connect.Request[v1.UpdateWebhookRequest]) (*connect.Response[v1.UpdateWebhookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.WebhookService.UpdateWebhook is not implemented"))
}
