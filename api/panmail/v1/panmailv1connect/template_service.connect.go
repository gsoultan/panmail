...
const (
	...
	TemplateServiceName = "panmail.v1.TemplateService"
)
...
const (
	...
	// CreateTemplate RPC.
	TemplateServiceCreateTemplateProcedure = "/panmail.v1.TemplateService/CreateTemplate"
	// TemplateServiceGetTemplateProcedure is the fully-qualified name of the TemplateService's
	// GetTemplate RPC.
	TemplateServiceGetTemplateProcedure = "/panmail.v1.TemplateService/GetTemplate"
	// TemplateServiceListTemplatesProcedure is the fully-qualified name of the TemplateService's
	// ListTemplates RPC.
	TemplateServiceListTemplatesProcedure = "/panmail.v1.TemplateService/ListTemplates"
	// TemplateServiceUpdateTemplateProcedure is the fully-qualified name of the TemplateService's
	// UpdateTemplate RPC.
	TemplateServiceUpdateTemplateProcedure = "/panmail.v1.TemplateService/UpdateTemplate"
	// TemplateServiceDeleteTemplateProcedure is the fully-qualified name of the TemplateService's
	// DeleteTemplate RPC.
	TemplateServiceDeleteTemplateProcedure = "/panmail.v1.TemplateService/DeleteTemplate"
)

// TemplateServiceClient is a client for the panmail.v1.TemplateService service.
...
// NewTemplateServiceClient constructs a client for the panmail.v1.TemplateService service. By
...
func NewTemplateServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TemplateServiceClient {
	...
	templateServiceMethods := v1.File_panmail_v1_template_service_proto.Services().ByName("TemplateService").Methods()
...
// CreateTemplate calls panmail.v1.TemplateService.CreateTemplate.
...
// GetTemplate calls panmail.v1.TemplateService.GetTemplate.
...
// ListTemplates calls panmail.v1.TemplateService.ListTemplates.
...
// UpdateTemplate calls panmail.v1.TemplateService.UpdateTemplate.
...
// DeleteTemplate calls panmail.v1.TemplateService.DeleteTemplate.
...
// TemplateServiceHandler is an implementation of the panmail.v1.TemplateService service.
...
func NewTemplateServiceHandler(svc TemplateServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/panmail.v1.TemplateService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTemplateServiceHandler) CreateTemplate(context.Context, *connect.Request[v1.CreateTemplateRequest]) (*connect.Response[v1.CreateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.TemplateService.CreateTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) GetTemplate(context.Context, *connect.Request[v1.GetTemplateRequest]) (*connect.Response[v1.GetTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.TemplateService.GetTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) ListTemplates(context.Context, *connect.Request[v1.ListTemplatesRequest]) (*connect.Response[v1.ListTemplatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.TemplateService.ListTemplates is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) UpdateTemplate(context.Context, *connect.Request[v1.UpdateTemplateRequest]) (*connect.Response[v1.UpdateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.TemplateService.UpdateTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) DeleteTemplate(context.Context, *connect.Request[v1.DeleteTemplateRequest]) (*connect.Response[v1.DeleteTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("panmail.v1.TemplateService.DeleteTemplate is not implemented"))
}
